...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/adorn-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14815&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/adorn-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `adorn` can be installed with:

```
conda install adorn
```

It is possible to list all of the versions of `adorn` available on your platform with:
